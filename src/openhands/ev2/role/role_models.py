...
class Role(Base):
    ...
    secret_provider_permission: Mapped[Permission | None] = mapped_column(
        PermissionType,
        default=None,
        comment="Permission policy for secret_provider resources; null = deny.",
    )
    static_secret_permission: Mapped[Permission | None] = mapped_column(
        PermissionType,
        default=None,
    ...
    mcp_aggregated_usage_permission: Mapped[Permission | None] = mapped_column(
        PermissionType,
        default=None,
    ...
    feature_flag_role_assignment_permission: Mapped[Permission | None] = mapped_column(
        PermissionType,
        default=None,
    ...
    group_permission: Mapped[Permission | None] = mapped_column(
        PermissionType,
        default=None,
        comment="Permission policy for group resources; null = deny.",
    )
    group_user_permission: Mapped[Permission | None] = mapped_column(
        PermissionType,
        default=None,

...
class ApiKeyService:
    ...
    async def apply_batch(
        ...
        *creator_id* is the current principal and is used as the subject of any
    ...
    async def _batch_create(
        ...
        *,
        ...
        _key, row = await ApiKeyService(self._session, filt).create(op.data, creator_id=creator_id)
        return row

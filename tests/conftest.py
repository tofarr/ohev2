...
from openhands.ev2.conversation_record.conversation_record_models import (
    ConversationRecord,  # noqa: F401
)
...
def _build_schema(host: str, port: int, user: str, password: str, dbname: str) -> None:
    ...
    import openhands.ev2.conversation_record.conversation_record_models

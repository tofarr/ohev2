"""add allowed_origins table and cors_origin permission type

Revision ID: 0006_allowed_origins
Revises: 0005_auth2
Create Date: 2026-06-05

Adds the CORS allow-list schema:
...
* ``allowed_origins`` — the single table holding the serialized browser
  ...
  requests to this API. The list is a deployment-level concern, managed via
  the ``/cors-origins`` REST resource and read by the CORS middleware
...
revision: str = "0006_allowed_origins"
